...
base = Path('fixtures/projections/ddd-graphql-core-fields')
...
assert len(report['residuals']) == 24
...
evidence = {'scope': 'Pinned GraphQL-core schema parse/build/validation of DDD core-Field-backed entity SDL; no resolver or query execution',
