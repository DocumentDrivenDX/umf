...
const paths=['native/postgresql/catalog/image.json','native/postgresql/catalog/snapshot.sql','src/core-ideals/facets-postgresql-projection.ts','spec/core/facets-postgresql-projection.schema.json','scripts/core-ideals/facets-postgresql-projection-cases.ts','scripts/core-ideals/facets-postgresql-projection-native.ts'];
