...
const proof=await Bun.file('fixtures/validation/key-tablespec-projection-native.json').json();assert.equal(proof.rows.length,12);assert.equal(proof.nativeVersion,'647e8e566ad78b864282ec65c0b0b2237aa63084');
