...
try{
 ...
 assert.deepEqual(checks,{cases:36,projected:12,blocked:24,idealRecoveries:24,nativeSourcePairRecoveries:24,classifiedNativeRecoveries:24,refusals:24,getterCalls:0});assert.deepEqual(externalRequests,[]);
