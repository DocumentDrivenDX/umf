...
try{
 ...
 await Bun.write('fixtures/validation/key-sqlserver-browser.json',JSON.stringify({scope:'Pinned SQL Server native Key classification, exact retained source recovery and refusal parity only. Authored projection and binding acceptance have separate evidence; no ideal-admission claim.',browser:browser.version(),checks,externalRequests,sha256},null,2)+'\n');console.log(JSON.stringify(checks));
