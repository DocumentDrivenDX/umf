...
corpus = 'fixtures/validation/cardinality-parquet-projection-corpus.json'
...
paths = [corpus, __file__, 'src/core-ideals/parquet-cardinality-carrier.ts',
         'scripts/core-ideals/cardinality-parquet-projection-cases.ts',
         'scripts/core-ideals/cardinality-parquet-projection-oracle.ts',
         'src/core-ideals/cardinality-parquet-projection.ts']
record = {'runtime': 'PyArrow ' + pa.__version__, 'scope': 'Generated authored-projection schemas and independent native row writes; retained ideal recovery is checked by Bun, no row conversion or native equivalence',
...
Path('fixtures/validation/cardinality-parquet-projection-native.json').write_text(json.dumps(record, indent=2) + '\n')
