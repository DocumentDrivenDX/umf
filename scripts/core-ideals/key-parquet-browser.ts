...
try{
 ...
 await Bun.write('fixtures/validation/key-parquet-browser.json',JSON.stringify({scope:'Parquet Key native observation, exact file recovery and refusals only; authored projection and full binding acceptance remain unfinished.',browser:browser.version(),checks,externalRequests,sha256},null,2)+'\n');console.log(JSON.stringify(checks));
