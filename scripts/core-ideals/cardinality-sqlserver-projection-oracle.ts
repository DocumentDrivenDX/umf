...
try{
 ...
 for(const c of sqlserverCardinalityProjectionCases()){
  ...
  const vectors:[string,number][]=c.request.storage==='json-array'?[["N'[3,1,3]'",0],["N'[]'",0],["N'[[1],[],[2,3]]'",0],["N'[1,null,\"x\",{}]'",0],["N'{}'",547],["N'7'",547],['NULL',0]]:c.request.storage==='json-object'?[["N'{\"x\":1}'",0],["N'{\"x\":1,\"x\":2}'",0],["N'[]'",547],["N'null'",547],['NULL',0]]:[['7',0],['NULL',0]];
