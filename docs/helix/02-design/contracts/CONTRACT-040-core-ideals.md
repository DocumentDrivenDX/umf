...
Experimental facet core 0.5.0 has passed core-task acceptance. TableSpec and
PostgreSQL facet bindings have qualified acceptance. SQL Server, Avro and Parquet
facet bindings, facet admission/delivery, key and native-equivalence graduation
remain pending.
