...
Experimental facet core 0.5.0 has passed core-task acceptance. The TableSpec facet
binding has qualified acceptance. PostgreSQL, SQL Server, Avro and Parquet facet
bindings, facet admission/delivery, key and native-equivalence graduation remain pending.
