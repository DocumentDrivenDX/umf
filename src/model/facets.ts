...
export function declareCoreFacets(input:Document,identity:CoreFacetIdentity,options:CoreFacetPatch):CoreFacetDeclaration {
 ...
 if(source.umf!=='0.5.0'&&source.umf!=='0.6.0'&&source.umf!=='0.7.0')throw new UmfError('CORE_FACET_VERSION','Explicit envelope migration is required before authoring facets');
