...
export function declareCoreElementKind(input:Document,identity:CoreKindIdentity,kind:ElementKind):CoreKindDeclaration {
 ...
 if(source.umf!=='0.2.0'&&source.umf!=='0.3.0'&&source.umf!=='0.4.0'&&source.umf!=='0.5.0'&&source.umf!=='0.6.0'&&source.umf!=='0.7.0')throw new UmfError('CORE_KIND_VERSION','Explicit envelope migration is required before authoring kind');
 ...
 return finish({operation:'declare-core-kind',version:source.umf==='0.7.0'?'6.0.0':source.umf==='0.6.0'?'5.0.0':source.umf==='0.5.0'?'4.0.0':source.umf==='0.4.0'?'3.0.0':source.umf==='0.3.0'?'2.0.0':'1.0.0',source,target,identity:located.identity,provenance:{origin:'authored',idealPath:path,kind,binding:{id:'umf.core.kind.authoring',version:source.umf==='0.7.0'?'6.0.0':source.umf==='0.6.0'?'5.0.0':source.umf==='0.5.0'?'4.0.0':source.umf==='0.4.0'?'3.0.0':source.umf==='0.3.0'?'2.0.0':'1.0.0'},basis:'explicit-author-declaration',nativePath:null}});
}
