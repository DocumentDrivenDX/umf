...
export function declareCoreNullability(input:Document,identity:CoreNullabilityIdentity,nullability:Nullability):CoreNullabilityDeclaration {
 ...
 if(source.umf!=='0.3.0'&&source.umf!=='0.4.0'&&source.umf!=='0.5.0'&&source.umf!=='0.6.0'&&source.umf!=='0.7.0')throw new UmfError('CORE_NULLABILITY_VERSION','Explicit envelope migration is required before authoring nullability');
 ...
 return finish({operation:'declare-core-nullability',version:source.umf==='0.7.0'?'5.0.0':source.umf==='0.6.0'?'4.0.0':source.umf==='0.5.0'?'3.0.0':source.umf==='0.4.0'?'2.0.0':'1.0.0',source,target,identity:located.identity,provenance:{origin:'authored',idealPath:path,nullability,binding:{id:'umf.core.nullability.authoring',version:source.umf==='0.7.0'?'5.0.0':source.umf==='0.6.0'?'4.0.0':source.umf==='0.5.0'?'3.0.0':source.umf==='0.4.0'?'2.0.0':'1.0.0'},basis:'explicit-author-declaration',nativePath:null}});
}
